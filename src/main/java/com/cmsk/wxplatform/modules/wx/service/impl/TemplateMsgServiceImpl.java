package com.cmsk.wxplatform.modules.wx.service.impl;

import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.cmsk.wxplatform.config.TaskExcutor;
import com.cmsk.wxplatform.modules.wx.entity.TemplateMsgLog;
import com.cmsk.wxplatform.modules.wx.entity.WxUser;
import com.cmsk.wxplatform.modules.wx.form.TemplateMsgBatchForm;
import com.cmsk.wxplatform.modules.wx.service.MsgTemplateService;
import com.cmsk.wxplatform.modules.wx.service.TemplateMsgLogService;
import com.cmsk.wxplatform.modules.wx.service.TemplateMsgService;
    ...
    public void sendTemplateMsg(WxMpTemplateMessage msg,String appid) {
        //TaskExcutor.submit(() -> {
            ...
            try {
                ...
                logger.info("发送模板消息成功！result={}", JSONObject.toJSONString(result));
